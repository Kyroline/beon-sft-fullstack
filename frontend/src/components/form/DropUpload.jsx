...
const DropUpload = ({ required, onUploadSuccess, onError, onUploadStart }) => {
        ...
        <div {...getRootProps()} className="p-2 bg-white w-full h-full rounded-3xl border-2 border-dashed border-gray-600 flex justify-center items-center">
            {
                uploadProgress > -1 ?
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className='text-xs'>jpeg, jpg, png, gif, bmp, or webp</p>
                    </div>
            }
            <input required={required} type="file" accept='image/*' name="" id="" {...getInputProps()} />
        </div>
    )
}
